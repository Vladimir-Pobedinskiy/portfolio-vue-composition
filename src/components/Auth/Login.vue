  ...
  <div class="login">
    ...
    >
      ...
      <div class="login__password-recovery-btn-wrapper">
        <button class="login__password-recovery-btn p3" type="button" :disabled="isLoading" @click="$router.push('/password-recovery/')">
          Забыли пароль?
        </button>
      </div>
      <button class="login__btn-submit btn" type="submit" :disabled="isLoading" >
        Войти
      </button>
